...
Feature: Moon Updating
  ...
  Scenario Outline: User provides valid moon data
    When the user enters a moon name "<valid moon name>" in the moon update form
    And  the user selects a file "<valid file>" in the moon update form
    ...
    Examples:
      |valid moon name|owner id|valid file  |alert message             |
  ...
  Scenario Outline: User provides invalid moon data
    When the user enters a moon name "<invalid moon name>" in the moon update form
    And  the user selects a file "<invalid file>" in the moon update form
    And  the user enters an ownerId <owner id> in the moon update form
    And  the user clicks submit in the moon update form
    Then the user should get a browser alert saying "<alert message>"

    Examples:
      |invalid moon name              |owner id|invalid file   |alert message    |
      |                               |2       |               |Invalid moon name|
